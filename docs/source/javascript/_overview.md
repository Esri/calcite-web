...
Calcite Web includes a small JavaScript library. `calcite-web.js` is a lightweight and dependency-free library made to enable behaviors for [patterns](../patterns/) and [components](../components).
