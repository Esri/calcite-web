...
function filterDropdown () {
  ...
  function bindFilterDropdowns () {
    ...
    dropdowns.forEach(function (dropdown) {
      ...
      var opens = dom.findElements('.js-filter-dropdown-close', options.parent)
      var closes = dom.findElements('.js-filter-dropdown-open', options.parent)
  ...
  function openList (options) {
    ...
    for (let i = 0; i < opens.length; i++) {
      var open = opens[i];
      classy.remove(open, 'is-active');
    }
    for (let i = 0; i < closes.length; i++) {
      var close = closes[i];
      classy.add(close, 'is-active');
    }
  }
  ...
  function closeList (e) {
    ...
    for (let i = 0; i < opens.length; i++) {
      var open = opens[i];
      classy.add(open, 'is-active');
    }
    for (let i = 0; i < closes.length; i++) {
      var close = closes[i];
      classy.remove(close, 'is-active');
    }
  }
